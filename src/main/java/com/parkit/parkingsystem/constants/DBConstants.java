...
/**
 * DBConstants is the class where informations are set and saved according to
 * the vehicle registering steps.
 *
 * @author BBornier
 * 
 * @version 0.1
...
public class DBConstants {
	...
	public static final String GET_NEXT_PARKING_SPOT = "select min(PARKING_NUMBER) from parking where AVAILABLE = "
			+ "true and TYPE = "
			+ "?";
